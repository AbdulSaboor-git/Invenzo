...
export default function AddProduct({
  ...
  return (
    <div className="flex fixed z-40 top-0 flex-col p-5 w-screen h-screen items-center justify-center bg-[#00000040] backdrop-blur-[2px] ">
      <div className="pt-4 md:pt-4 p-7 md:p-10 mx-10 z-40 w-full max-w-[400px] md:max-w-[450px] overflow-auto hidden_scroll_bar bg-[#dfeaea] rounded-lg shadow-lg text-[#404040]">
        ...
        <form className="space-y-3 text-xs md:text-sm text-gray-700 ">
          ...
          <div className="flex flex-col">
            ...
            <input
              type="text"
              className="px-3 mb-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-600"
            />
          </div>
