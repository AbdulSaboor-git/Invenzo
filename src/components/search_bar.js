    ...
    <div className="flex w-full items-stretch ">
      <div className="relative w-full text-gray-500 h-10">
        <input
          ...
          className={`${className} border border-gray-200 md:border-green-200 md:border-r-0 rounded-s-md rounded-e-md md:rounded-e-none md:rounded-s-md px-3 py-2 pr-7 w-full text-sm h-10
